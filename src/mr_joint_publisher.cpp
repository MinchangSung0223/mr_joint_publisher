...
private:
  ...
  Indy7 *indy7 = new Indy7("/home/sung/ros2_humble/src/mr_joint_publisher/MR_info.json");
  ...
  // INVERSE DYNAMICS 
    ...
    JVec qddot_ref = Kv*(-dq) + Kp*(q_desired- q);
   ...
   // FOWRAD DYNAMIC SIMULATION
    ...
    if(++print_count>=CONTROL_RATE/10){
      cout<< "q_err : "<<(q_desired- q).transpose()<<endl;
      print_count = 0;
    }
    t=  t+dt;
  }
